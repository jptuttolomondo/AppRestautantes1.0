...
import {useGetComandaByIdSelector} from  '../../selectors/cocina.selectors.jsx'
import{ChangeStateAndUpdateComanda}from'../../actions/cocina.actions.jsx'
...
console.log('listacomandas',listaComandas[0]._id,'comandaGetted',comandaGetted._id)
let comandaCambiada={}
...
function handleClick(payload){
    ...
    if(payload==='LISTO PARA SERVIR'&&listaComandas[0]._id!==comandaGetted._id) alert('Falta servir una comanda anterior')
else {
